...
**进度 133 / 149。** 回归读数：`uitest` **119/119** · `plugintest` 22/22 · `captest` 38/38 · `kindtest` 34/34 · `selftest` 零 error · `lifecycletest` 全通 ·
...
3. **M11-5** 把 `.md` 改造成插件（`20` P6）—— 要先做 A 面的前端宿主：详情区一块矩形 + postMessage 桥
