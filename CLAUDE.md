...
每做完一条更新 `doc/12` 的状态与进度表，读数写进 `doc/00`。设计侧**第十轮已发**（`uploads/38-…` 插件市场四屏），等它交回。
...
**进度 136 / 153。** 回归读数：`uitest` **127/127** · `captest` 228/228 · `plugintest` 34/34 · `plugintest` 22/22 · `captest` 43/43 · `kindtest` 34/34 · `selftest` 零 error · `lifecycletest` 全通 ·
